...
Let Y be a random variable, and $p(y) = P(Y =y)$.  Suppose that Y takes the values $\{ y_1, y_2, \cdots, y_k\}$  where k may be $\infty$. Then

1. $0 \le P(Y = y_i) \le 1$	

2. $\sum_{i=1}^k P(Y=y_i)$	 
...
$$\mu = E[X]  = 3/8 + 2 (3/8) + 3 (1/8) = 3(1+2+1)/8 = 3/2.$$
...
```{r fig.align='center', out.width = '15%'}
