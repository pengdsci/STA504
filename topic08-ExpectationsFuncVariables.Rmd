...
**Definition**: Let $Y_1$ and $Y_2$ be the two random variable with $\mu_1 = E[Y_1]$ and $\mu_2 = E[Y_2]$, the covariance of $Y_1$ and $Y_2$ is defined to be
$$
...
$$
\text{COV}(Y_1,Y_2) = \iint_{ D_{Y_1Y_2}} (y_1-\mu_1)(y_2-\mu_2)p(y_1,y_2)dA,
$$
