...
(c). $$P(.1 \le Y1 \le .3, 0 \le Y2 \le .5) =\iint_{\{D: .1 \le Y1 \le .3, 0 \le Y2 \le .5\}}f(y_1, y_2)dA$$
...
The orange region is neither type I nor a type II region. We split it into $\mathcal{R_1}$ (type II region) and $\mathcal{R_2}$ (both type I and type II regions). We can then set up the double integral in the following
